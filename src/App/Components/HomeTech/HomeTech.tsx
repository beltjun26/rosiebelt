...
export const HomeTech: React.FC = () => {
  ...
  function openModal(tech: TECHNOLOGY, logo: React.ReactNode) {
    ...
    <S.HomeTech>
      <S.HomeTechContainer>
        ...
        <S.BalloonsContainer>
          ...
          <S.Balloon left={7} top={-6} onClick={() => openModal('react', <S.LogoReact />)}>
            <S.LogoReact />
          </S.Balloon>
          <S.Balloon left={16} top={-2} onClick={() => openModal('gtm', <S.BalloonImg src={LogoGtm}/>)}>
            <S.BalloonImg src={LogoGtm}/>
          </S.Balloon>
          <S.Balloon left={24} top={-9} onClick={() => openModal('mysql', <S.LogoMysql />)}>
            <S.LogoMysql />
          </S.Balloon>
          <S.Balloon left={8.4} top={4} onClick={() => openModal('apollo', <S.BalloonImg src={LogoApollo}/>)}>
            <S.BalloonImg src={LogoApollo}/>
          </S.Balloon>
          <S.Balloon left={28} top={1} onClick={() => openModal('git', <S.BalloonImg src={LogoGit}/>)}>
            <S.BalloonImg src={LogoGit}/>
          </S.Balloon>
          <S.Balloon left={19} top={6} onClick={() => openModal('github', <S.BalloonImg src={LogoGithub}/>)}>
            <S.BalloonImg src={LogoGithub}/>
          </S.Balloon>
          <S.Balloon left={2} top={12.3} onClick={() => openModal('ga', <S.LogoGoogleAnalytics/>)}>
            <S.LogoGoogleAnalytics/>
          </S.Balloon>
          <S.Balloon left={27} top={11.3} onClick={() => openModal('graphql', <S.LogoGraphQl/>)}>
            <S.LogoGraphQl />
          </S.Balloon>
          <S.Balloon left={12.4} top={11.3} onClick={() => openModal('phab', <S.BalloonImg src={LogoPhabricator} />)}>
            <S.BalloonImg src={LogoPhabricator} />
          </S.Balloon>
          <S.Balloon left={7.4} top={20.3} onClick={() => openModal('php', <S.BalloonImg src={LogoPhp} />)}>
            <S.BalloonImg src={LogoPhp} />
          </S.Balloon>
          <S.Balloon left={20} top={16.3} onClick={() => openModal('twilio', <S.BalloonImg src={LogoTwilio} />)}>
